    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/sysLog/list.action"
                      method="get">

                    <div class="form-group">
                        <label for="community_name">用户名</label>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <itcast:page url="${pageContext.request.contextPath }/sysLog/list.action"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
