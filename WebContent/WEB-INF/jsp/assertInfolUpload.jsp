...
<body>
<form id="inputForm" action="${pageContext.request.contextPath}/assertInfol/uploadAssertInfol.action"
    ...
    <div class="main-box"  style="padding: 50px">
        ...
        <div class="form-group"  style="margin-top: 20px">
            <button type="submit" class="btn btn-primary"  onclick="uploadThread();">上传</button>
