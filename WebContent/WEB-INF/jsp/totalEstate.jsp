            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <itcast:page url="${pageContext.request.contextPath }/totalEstate/list.action"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
...
<!-- 编辑每个月物业费对话框 -->
<div class="modal fade" id="EditTotalEstateDialog" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">更新合同物业费收入信息</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="edit_TotalEstate_form">
                    ...
                    <div class="form-group">
                        <label for="edit_estate" class="col-sm-2 control-label">应收物业费</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="edit_estate" placeholder="应收物业费（元）"
                                   name="estate">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="edit_reality_estate" class="col-sm-2 control-label">实际收物业费</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="edit_reality_estate" placeholder="截止抄表时间"
                                   name="reality_estate">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="updateTotalEstate()">保存修改</button>
            </div>
        </div>
    </div>
</div>
...
<!-- 新建每个月物业费对话框 -->
<div class="modal fade" id="newTotalEstateDialog" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">添加合同物业费收入信息</h4>
            </div>
            <div class="modal-body">

                <form class="form-horizontal" id="new_TotalEstate_form">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="new_estate" class="col-sm-2 control-label">应收物业费</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="new_estate" placeholder="应收物业费（元）"
                                   name="estate">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="new_reality_estate" class="col-sm-2 control-label">实际收物业费</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="new_reality_estate" placeholder="截止抄表时间"
                                   name="reality_estate">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" onclick="createTotalEstate()">创建</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function editTotalEstate(id) {
        $.ajax({
            type: "get",
            url: "<%=basePath%>totalEstate/edit.action",
            data: {"id": id},
            success: function (data) {
                ...
                $("#edit_year_months").val(data.year_month);
