...
<frameset rows="85,*" cols="*" frameborder="no" border="0" framespacing="0">
    <frame src="${pageContext.request.contextPath}/top.action" name="topFrame" scrolling="no">
    <frameset cols="250,*" name="btFrame" frameborder="NO" border="0" framespacing="0">
        ...
        <frame src="${pageContext.request.contextPath}/assertInfol/list.action" class="frame_r" noresize name="main" scrolling="yes">
    </frameset>
</frameset>
<noframes>
